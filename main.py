...
SYSTEM_PRESETS = [
	{
		...
		"text": (
			...
			"- Avoid third-party packages unless they are clearly justified.\n"
			"- Prefer layered configuration precedence:\n"
			"  defaults < config file < environment variables\n"
			"- Prefer JSON-serializable return structures when reasonable.\n"
			"- Include small self-test/demo sections when appropriate.\n"
